          ...
          <div className="flex-1 p-[18px] pt-[18px] overflow-hidden">
            <div className="flex flex-col gap-1.5 mb-2.5">
              <div className="flex items-center gap-2.5 bg-[#111113] border border-white/7 rounded-[10px] px-3 py-2.25">
                <div className="w-7 h-7 rounded-[7px] bg-[#1a1a2e] flex items-center justify-center flex-shrink-0">
              ...
              <div className="flex items-center gap-2.5 bg-[#111113] border border-white/7 rounded-[10px] px-3 py-2.25">
                <div className="w-7 h-7 rounded-[7px] bg-[#0d1a0d] flex items-center justify-center flex-shrink-0">
                  <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
              ...
              <div className="flex items-center gap-2.5 bg-[#111113] border border-white/7 rounded-[10px] px-3 py-2.25">
                <div className="w-7 h-7 rounded-[7px] bg-[#1a100a] flex items-center justify-center flex-shrink-0">
                  <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
        ...
        <div className="bg-[#161618] border border-white/6 rounded-2xl overflow-hidden flex flex-col">
          <div className="flex-1 p-[18px] overflow-hidden">
            <div className="flex flex-col gap-2">
              ...
              <div className="bg-[#111113] border border-white/7 rounded-[10px] p-3 opacity-50">
                <div className="flex items-center gap-1.75 mb-1.25">
                  <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
          ...
          <div className="flex-1 p-[18px] overflow-hidden">
            <div className="flex flex-col gap-2.5">
              <div className="flex gap-0 items-center mb-0.5">
                <div className="w-20 h-1 bg-white/5 rounded-sm mr-1.5"></div>
          ...
          <div className="flex-1 p-[18px] overflow-hidden">
            <div className="bg-[#0e0e11] border border-white/7 rounded-[10px] overflow-hidden font-mono text-[10.5px]">
              <div className="flex items-center gap-1.25 px-3 py-1.75 border-b border-white/5">
                <div className="w-2.25 h-2.25 rounded-full bg-red-500"></div>
                <div className="w-2.25 h-2.25 rounded-full bg-yellow-400"></div>
                <div className="w-2.25 h-2.25 rounded-full bg-green-500"></div>
